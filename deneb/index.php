...
<body>
    <div class="mdl-layout mdl-js-layout" style="background: url('../assets/img_milkyway_0.jpg') center / cover;">
        ...
        <main class="mdl-layout__content">
            ...
            <div style="padding-top: 168px; padding-bottom: 168px;">
                ...
                <h4 class="mdl-color-text--white" style="text-align: center; text-shadow: 0 2px 2px #888">Rank Management System</h4>
            ...
            <div class="mdl-grid">
                ...
                <div class="mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--8-col mdl-cell--2-offset-desktop" style="padding: 0 24px 24px 24px">
                    ...
                    마인크래프트 랭크 관리 시스템, Deneb입니다. Deneb를 이용하여 쉽고 간단하게 랭킹 시스템을 추가할 수 있습니다. Deneb를 사용하기 위해서는 <a href="https://github.com/Astro36/AstroLibrary/releases">AstroLibrary</a>를 다운로드하고 스크립트와 함께 적용하세요. 아래와 같은 방식으로 Deneb를 사용할 수 있습니다.<br><br>
